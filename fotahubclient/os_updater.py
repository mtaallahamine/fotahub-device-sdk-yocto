...
UBOOT_ACTIVATE_OS_UPDATE_FLAG = 'os_update_activated'
UBOOT_CONFIRM_OS_UPDATE_FLAG = 'os_update_confirmed'
UBOOT_REVERT_OS_UPDATE_FLAG = 'os_update_reverted'
...
class OSUpdater(OSTreeClient, UBootOperator):
    ...
    def revert_os_update(self):
        ...
        self.set_uboot_env_var(UBOOT_REVERT_OS_UPDATE_FLAG, '1')
        self.reboot()
